...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   pool2.on('connect', function (client) {
...
var www221 = await pool2.connect();
...
www221.query(sql, function (error, results, fields) {
	
	if (results)response(results)	
	else if (error)reject(error)
	else response('wibzi');
	www221.end(()=> {  console.log('sql query was finished'); });
});
